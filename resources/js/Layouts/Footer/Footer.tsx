    ...
    <div className='bg-white'>
      <AppLayoutPadding>
        <div className='w-full border-t py-8'>
          <div className='relative w-full py-24 lg:py-14'>
            <div className='grid grid-cols-2 gap-x-5 gap-y-10 sm:gap-x-8 md:grid-cols-4 lg:grid-cols-5 lg:gap-x-10'>
              <div className='col-span-2 grid grid-cols-4 gap-5 md:col-span-4 lg:md:col-span-1 lg:flex lg:flex-col'>
                <div className='col-span-2 md:col-span-1'>
                  <Link
                    href='/'
                    className={`inline-block w-36 focus:outline-none focus:ring-0`}
                  >
                    <ApplicationLogo />
                  </Link>
                </div>
            ...
            <div className='flex'>
              {blockData?.facebook != null && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='flex items-center rounded bg-[#3b5998] p-2 leading-none text-white transition hover:bg-[#2d4373]'
                >
                  <svg
                    className='h-5 w-5'
                    fill='currentColor'
            ...
            <div className='flex'>
              {blockData?.twitter != null && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='flex rounded bg-black p-2 leading-none text-white transition hover:bg-[#1da1f2]'
                >
                  <svg
                    className='h-5 w-5'
                    fill='currentColor'
            ...
            <div className='flex'>
              {blockData?.youtube != null && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='flex items-center justify-center rounded bg-[#ff0000] p-2 leading-none text-white transition hover:bg-[#ff0000]'
                >
                  <svg
                    className='h-5 w-5'
                    fill='currentColor'
            ...
            <div className='flex'>
              {blockData?.instagram != null && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='flex rounded bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] p-2 text-white transition hover:opacity-90'
                >
                  <svg
                    className='h-5 w-5'
                    fill='currentColor'
