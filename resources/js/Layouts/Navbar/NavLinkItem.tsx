      ...
      <NavigationMenuList>
        <NavigationMenuItem>
          <Link
            ...
            target={linkInfo?.external ? '_blank' : undefined}
            rel={linkInfo?.external ? 'noopener noreferrer' : undefined}
            className={`font-heading relative overflow-hidden rounded-full py-4 text-lg transition-all duration-300 2xl:text-lg ${navigationMenuTriggerStyle()} text-spontaine-dark/60 hover:text-spontaine-dark`}
