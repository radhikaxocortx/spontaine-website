      ...
      <NavigationMenuList>
        <NavigationMenuItem>
          <Link
            ...
            target={linkInfo?.external ? '_blank' : undefined}
            rel={linkInfo?.external ? 'noopener noreferrer' : undefined}
            className={`relative overflow-hidden rounded-full py-4 text-lg shadow-2xl transition-all duration-300 2xl:text-lg ${navigationMenuTriggerStyle()} text-black/60 hover:text-black`}
