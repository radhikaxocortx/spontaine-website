...
const SectionHeroImageSP = ({
  ...
  return (
    <section
      id='hero'
      className={`relative min-h-[80vh] w-full overflow-hidden md:min-h-[70vh] xl:min-h-[100vh] ${blockData?.marginTop} ${blockData?.marginBottom} ${blockData?.paddingTop} ${blockData?.paddingBottom}`}
    >
      {/* BACKGROUND IMAGE */}
