...
export default function HeroActions() {
  return (
    <div className='flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center'>
      <a
        href='/proof#book'
        className={`${actionBase} text-spontaine-ink-dark hover:bg-spontaine-ink-highlight bg-spontaine-accent-approved w-full sm:w-[229px]`}
      >
        See it at your Company &rarr;
      </a>
      <a
        href='/architecture'
        className={`${actionBase} border-spontaine-border-muted text-spontaine-ink-dark hover:bg-spontaine-accent-hover backdrop-blur-spontaine-sm w-full border-[1.5px] bg-white/20 sm:w-[149px]`}
      >
        Play the video
      </a>
    </div>
